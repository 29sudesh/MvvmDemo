...
public class LoginWithMobileRequest implements Parcelable
{
    ...
    public String toString() {
        return new ToStringBuilder(this).append("adminId", adminId).append("contryCode", contryCode).append("phone", phone).append("password", password).append("deviceId", deviceId).append("deviceType", deviceType).toString();
    }
