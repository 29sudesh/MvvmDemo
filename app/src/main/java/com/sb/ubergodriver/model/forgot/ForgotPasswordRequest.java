package com.sb.ubergodriver.model.forgot;
...
public class ForgotPasswordRequest implements Parcelable
{
    ...
    public String toString() {
        return new ToStringBuilder(this).append("contryCode", contryCode).append("phone", phone).append("email", email).append("newPassword", newPassword).append("adminId", adminId).toString();
    }
