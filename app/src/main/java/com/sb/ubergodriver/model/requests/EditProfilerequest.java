...
public class EditProfilerequest implements Parcelable
{
    ...
    public String toString() {
        return new ToStringBuilder(this).append("driverId", driverId).append("firstName", firstName).append("lastName", lastName).append("contryCode", contryCode).append("phone", phone).append("dob", dob).append("gender", gender).append("bio", bio).append("profilePic", profilePic).toString();
    }
