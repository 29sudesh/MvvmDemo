...
public class SupportViewModel extends ViewModel {
    ...
    public SupportViewModel(Repository repository) {
     ...
     * */
    public void hitSupportApi(SupportRequest loginRequest) {


        disposables.add(repository.executeSupport(loginRequest)
